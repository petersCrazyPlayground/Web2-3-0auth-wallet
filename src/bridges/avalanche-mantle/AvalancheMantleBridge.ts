...
export class AvalancheMantleBridge implements IBridge {
    ...
    private bridgeId: string = 'avalanche-mantle-bridge';
    ...
    async initialize(): Promise<void> {
        try {
            ...
            this.addSupportedToken(
                ...
                '0xCAbAE6f6Ea1ecaB08Ad02fE02ce9A44F09aebfA2', // WBTC on Mantle
