...
export class AvalancheSkaleBridge implements IBridge {
    ...
    private bridgeId: string = 'avalanche-skale-bridge';
    ...
    async initialize(): Promise<void> {
        try {
            ...
            this.addSupportedToken(
                ...
                '0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34', // USDC on SKALE
            ...
            this.addSupportedToken(
                ...
                '0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5', // USDT on SKALE
